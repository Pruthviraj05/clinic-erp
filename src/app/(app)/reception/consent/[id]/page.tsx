...
export default async function ReceptionConsentDetailPage({ params }: { params: Promise<{ id: string }> }) {
  await requirePermission("consent", "view");
  ...
  return (
    <div className="space-y-4">
      <Link href="/reception/consent" className="print-hide inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground">
